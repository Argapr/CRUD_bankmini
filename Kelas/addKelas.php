...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO kelas (nama) VALUES ('$nama')";
...
<head>
  ...
  <script>
    function validateForm() {
      let isValid = true;
      const inputs = document.querySelectorAll("#kelasForm input");
      const errorMessages = [];
    ...
    <div class="shadow mb-5 bg-body">
      <nav class="navbar shadow-sm">
        <div class="container-fluid">
          <span class="navbar-brand mb-0 h1">Add Kelas</span>
        </div>
      </nav>
      <form id="kelasForm" action="" method="POST" onsubmit="confirmSubmission(event)">
